functionWrapper = @(X) (rosenbrockFunction(X(1), X(2))); 
...
% Plot results
graphWrapper = @(X1, X2) (rosenbrockFunction(X1, X2));
plotService = PlotService();
%figure();
%plotService.createGif(results, graphWrapper, [-2.048 2.048], [-2.048 2.048], 'x', 'y', 10, 20, 'figure.gif', 0.2, 'gif');
% figure();
% plotService.figureByIteration(1, results, graphWrapper, [-2.048 2.048], [-2.048 2.048], 'x', 'y', 10, 100);
% figure();
% if rem(results.iterations, 2) == 1
% plotService.figureByIteration((results.iterations+1)/2, results, graphWrapper, [-2.048 2.048], [-2.048 2.048], 'x', 'y', 10, 100);
% else
% plotService.figureByIteration(results.iterations/2, results, graphWrapper, [-2.048 2.048], [-2.048 2.048], 'x', 'y', 10, 100);
% end
% figure();
% plotService.figureByIteration(results.iterations, results, graphWrapper, [-2.048 2.048], [-2.048 2.048], 'x', 'y', 10, 100);
% figure();
% plotService.figure3D(graphWrapper, config.bounds, config.bounds, [0 180000], 'x', 'y', 'z', 'Rosenbrock', 200)
